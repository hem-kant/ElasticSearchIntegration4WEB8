...
namespace ElasticSearchIndexService
{
    ...
    public interface IIndexService
    {
        ...
        [OperationContract]
        ESI4TServiceResponse<IndexResponse> AddDocument(ESI4TServiceRequest<IndexRequest> query);
        ...
        [OperationContract]
        ESI4TServiceResponse<IndexResponse> RemoveDocument(ESI4TServiceRequest<IndexRequest> query);
